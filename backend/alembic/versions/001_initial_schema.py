...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('affiliate_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('program_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('conversion_type', sa.Enum('SALE', 'LEAD', 'SIGNUP', 'CUSTOM', name='conversiontype'), nullable=False),
        sa.Column('status', sa.Enum('PENDING', 'VALIDATED', 'REJECTED', 'REVERSED', name='conversionstatus'), nullable=False, server_default='PENDING'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', name='payoutstatus'), nullable=False, server_default='PENDING'),
